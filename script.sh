...
_run_osc_pipeline() {
    ...
    echo "osc-rule-based-extractor --pdftohtml_mod_executable /data-extraction/osc-xpdf-mod/bin/pdftohtml_mod --raw_pdf_folder '$input_dir' --working_folder '$rb_work_dir' --kpi_folder "/data-extraction/osc-rule-based-extractor/res/kpi_specs_demo" --output_folder '$output_dir' --verbosity 0 > '$log_dir/rb.log' 2>/dev/null"
    osc-rule-based-extractor --pdftohtml_mod_executable /data-extraction/osc-xpdf-mod/bin/pdftohtml_mod --raw_pdf_folder "$input_dir" --working_folder "$rb_work_dir" --kpi_folder "/data-extraction/osc-rule-based-extractor/res/kpi_specs_demo" --output_folder "$output_dir" --verbosity 0 > "$log_dir/rb.log" 2>/dev/null
